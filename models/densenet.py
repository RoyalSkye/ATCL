...
class DenseNet(nn.Module):
    ...
    def __init__(self, depth=22, block=Bottleneck, dropRate=0, num_classes=10, growthRate=12, compressionRate=2, input_channel=3):
        ...
        self.conv1 = nn.Conv2d(input_channel, self.inplanes, kernel_size=3, padding=1, bias=False)
