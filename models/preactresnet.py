...
class PreActResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=10, input_channel=3):
        super().__init__()
...
def preactresnet18(input_channel=3, num_classes=10):
    return PreActResNet(PreActBasic, [2, 2, 2, 2], num_classes=num_classes, input_channel=input_channel)


def preactresnet34(input_channel=3, num_classes=10):
    return PreActResNet(PreActBasic, [3, 4, 6, 3], num_classes=num_classes, input_channel=input_channel)


def preactresnet50(input_channel=3, num_classes=10):
    return PreActResNet(PreActBottleNeck, [3, 4, 6, 3], num_classes=num_classes, input_channel=input_channel)


def preactresnet101(input_channel=3, num_classes=10):
    return PreActResNet(PreActBottleNeck, [3, 4, 23, 3], num_classes=num_classes, input_channel=input_channel)


def preactresnet152(input_channel=3, num_classes=10):
    return PreActResNet(PreActBottleNeck, [3, 8, 36, 3], num_classes=num_classes, input_channel=input_channel)
