...
CUDA_VISIBLE_DEVICES=0 nohup python -u main.py --method 'forward' --dataset 'mnist' 2>&1 &
```
...
|    resnet18 progressive min_free_max_free    |                  |     ATCL      |               |
...
<p align="center">  
  ...
  <img src="./ATCL_result/pro_resnet18_forward_test_acc.png" alt="pro_resnet18_forward" width="190" /></br>
	Figure 2: Nature & PGD20 test acc during progressive adversarial training (Resnet-18): </br>free, nn, ga, pc, </br>scl-exp, scl-nl and forward, respectively.
</p>
...
|    WRN-32-10 progressive min_forward_max_forward     |  ATCL3: 46.16M   |    16 / 14    |               |
| Warmup WRN-32-10 progressive min_forward_max_forward |      ATCL5       |    44 / 11    |               |

<p align="center">   
	<img src="./ATCL_result/cifar10_pro_resnet34_forward_test_acc.png" alt="pro_resnet34_forward" width="300" /></br>
